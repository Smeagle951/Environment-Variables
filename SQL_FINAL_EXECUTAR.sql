-- =====================================================
-- VIEWS PARA APP ADMIN DASHBOARD - VERSÃO FINAL
-- FortSmart Agro - Views de Estatísticas e Resumos
-- =====================================================
-- 
-- ✅ Esta versão NÃO depende da tabela 'farms'
-- ✅ Funciona mesmo se farms não existir
-- 
-- INSTRUÇÕES:
-- 1. Acesse: https://app.supabase.com
-- 2. Selecione seu projeto
-- 3. Vá em: SQL Editor (menu lateral)
-- 4. Cole TODO este conteúdo abaixo
-- 5. Clique em "Run" ou pressione Ctrl+Enter
-- 
-- ⚠️ IMPORTANTE: Execute apenas o conteúdo SQL, não o arquivo .md!
-- =====================================================
...
-- =====================================================
-- 2. VIEW: RESUMO DE GRUPOS (SEM FARMS)
-- =====================================================
...
SELECT 
  ...
  CASE 
    ...
    ELSE 'unknown'
  END as status,
  GREATEST(fg.updated_at, MAX(gm.updated_at)) as last_activity
